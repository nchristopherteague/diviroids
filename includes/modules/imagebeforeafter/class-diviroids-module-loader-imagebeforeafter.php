 ...
 *
 * @package    DiviRoids\Includes\Modules\ImageBeforeAfter\DiviRoids_Module_Loader_ImageBeforeAfter
 * @since      1.0.0
*/

if (!class_exists('DiviRoids_Module_Loader_ImageBeforeAfter')) :

    class DiviRoids_Module_Loader_ImageBeforeAfter extends DiviRoids_Module_Loader_Instance_Base
    {
   ...
   * @since 1.0.0
   */
  function DiviRoids_Module_Loader_ImageBeforeAfter()
  {
      return DiviRoids_Module_Loader_ImageBeforeAfter::getInstance();
  }

endif;

DiviRoids_Module_Loader_ImageBeforeAfter();
