 ...
 *
 * @package    DiviRoids\Includes\Modules\Rotator\DiviRoids_Module_Rotator_Image_Item
 * @since      1.0.0
*/

if (!class_exists('DiviRoids_Module_Rotator_Image_Item')) :

    class DiviRoids_Module_Rotator_Image_Item extends DiviRoids_Module_Builder_Base
    {
...
new DiviRoids_Module_Rotator_Image_Item;
